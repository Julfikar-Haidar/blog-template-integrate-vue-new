     ...
     <section class="featured-posts no-padding-top">
      <div class="container">
        ...
        <div class="row d-flex align-items-stretch">
          ...
          <div class="image col-lg-5"><img src="https://d19m59y37dris4.cloudfront.net/blog/1-2-1/img/featured-pic-1.jpeg" alt="..."></div>
        </div>
        <!-- Post        -->
        <div class="row d-flex align-items-stretch">
        ...
        <div class="row d-flex align-items-stretch">
          ...
          <div class="image col-lg-5"><img src="https://d19m59y37dris4.cloudfront.net/blog/1-2-1/img/featured-pic-3.jpeg" alt="..."></div>
        </div>
      </div>
    </section>
</template>
